...
export default class Left extends Component {
    ...
    componentDidMount() {
        ...
        window._wizard = {
            ...
            pullMenu: this.pullMenu,
            liftMenu: this.liftMenu,
            foldMenu: this.foldMenu,
            unfoldMenu: this.unfoldMenu
        }
        this.bindEvent()
        // 获取昵称
            ...
            <div className="side-bar" ref={left => this._left = left}>
                <div className="sidebar-bg">
                    <ul className="sidebar-nav">
                        <li className="avatar"><Avatar size={64} src={"http://q1.qlogo.cn/g?b=qq&nk=79328210&s=100"}/>
                        </li>
                        <li className="sign"><span><a href="http://wizardj.cn">{this.state.nikeName}</a></span></li>
                        <li className="motto" ref={_sign => this._sign = _sign}>
                            <span>"God was never on your side"</span></li>
                    ...
                    <ul className="sidebar-social">
                        ...
                        <li>
                            <Tooltip placement="bottomRight" title={"掘金社区"}>
                                <a href="https://juejin.im/user/5d2d8a2351882554c007bdcd" text="掘金社区"><i
                                    className="iconfont icon-web_xiangxiazhankai"></i></a>
                            </Tooltip>
                        </li>
                        <li>
                            <Tooltip placement="bottomRight" title={"同性交友社区"}>
                                <a href="https://github.com/Wizard-J" text="github"><i
                                    className="iconfont icon-github"></i></a>
                            </Tooltip>
                        </li>
                    </ul>
                </div>
